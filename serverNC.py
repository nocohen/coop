...
fh = logging.FileHandler('/tmp/coopLog.log')
...
class Coop(object):
    ...
    MAX_MOTOR_ON = 45 #longest time motor can be on - in seconds
	...
	self.motor_emergency = Coop.NORMAL
    ...
    def closeDoor(self):
        if (self.motor_emergency == Coop.EMERGENCY):
            return
...
#            logger.error("Error: " + e)
    ...
    def checkTriggers(self):
	    ...
	    #set triggered status - Triggered means one of the reed sensors is set off by a magnet in proximity, indicating full open or full closed.
            (top, bottom) = self.currentTriggerStatus()
    ...
    def emergencyStopDoor(self, reason):
        ...
        self.motor_emergency = Coop.EMERGENCY
